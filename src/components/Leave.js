...
class Leave extends Component {
    ...
    render(){
        ...
        const vacationBg = this.state.vacation ? styles.defaultBg : styles.containerWidth
        ...
        const vacationText = this.state.vacation ? styles.defaultFont : styles.smallFont
        ...
        return (
            <View style={parentContainer}>
                <ScrollView style={container}>
                    <View>
                        <Text style={headerText}>APPLY LEAVE</Text>
                        <View style={topicContainer}>
                            <Text style={topicText}>Casual / Sick</Text>
                        </View>
                        <Text style={balance}>Balance: 24 days</Text>
                    </View>
                    
                    <View style={reasonParent}>
                        <Text style={[headerText, smallHeaderFont]}>Reason</Text>
                        <View style={reasonContainer}>
                            ...
                            <TouchableOpacity style={[topicContainer, containerWidth, vacationBg]} onPress={()=>this.toggle('vacation')}>
                                <Text style={[topicText, smallFont, vacationText]}>Vacation</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
